...
if __name__ == "__main__":
    trajectory_file = "metallated/md_TripleCAg2T_solv_nWI.pdb" #Change
    output_file = "results/propeller_angles_results_TripleCAg2T.txt" #Change
    
    results = process_trajectory(
        trajectory_file=trajectory_file,
        output_file=output_file,
        max_models=100000 #Change
    )